...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .card-header{
        background-image: url("assets/abstract_6.jpg");
        background-size: cover;
        color:white;
      }
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark">
      <div class="navbar-brand display-2" id="nav1"><strong>ArtSpark Gallery</strong></div>
      ...
      <div class="card border-dark mb-3 text-center" style="width: 20rem;">
        ...
        <div class="card-body">
          ...
          <ul class="list-group list-group-flush">
            <li class="list-group-item border-success"><strong>Price:</strong> Rs.<?php echo $art_price;?></li>
        ...
        <div class="card-footer">
          ...
          <span class="badge badge-primary badge-pill"><?php echo "Rs.".$purchase_amt; ?></span>
        </div>
      </div>
